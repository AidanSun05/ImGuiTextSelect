...
This is a text selection implementation for Dear ImGui, extracted from [Network Socket Terminal](https://github.com/NSTerminal/terminal) on 01/05/2024 and released under the MIT License.
